...
#include "gv\time_measurement.hpp"
#include <math.h>
#include <iostream>
...
Eigen::Vector3d
gv::generateRandomPoint(double maximumDepth, double minimumDepth)
{
...
Eigen::Vector3d
gv::addNoise(double noiseLevel, Eigen::Vector3d cleanPoint)
{
...
Eigen::Vector3d
gv::generateRandomTranslation(double maximumParallax)
{
...
Eigen::Vector3d
gv::generateRandomDirectionTranslation(double parallax)
{
...
Eigen::Matrix3d
gv::generateRandomRotation(double maxAngle)
{
  Eigen::Vector3d rpy;
